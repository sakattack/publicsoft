 ...
 * @returns {{id: null, companyName: string, vatNumber: string, firstName: string, lastName: string, address: string, country: string, city: string, zipCode: string, irsOffice: string}}
 */
